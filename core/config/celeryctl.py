...
class CeleryConfig:
    BROKER_URL = 'redis://{}:{}/{}'.format(
        yeti_config.redis.host, yeti_config.redis.port,
    ...
    CELERY_ROUTES = {
        'core.analytics_tasks.single': {
            'queue': 'oneshot'
        },
        'core.feed.update_feed': {
            'queue': 'feeds'
        },
        'core.exports.export.execute_export': {
            'queue': 'exports'
        },
        'core.analytics_tasks.each': {
            'queue': 'analytics'
        },
        'core.analytics_tasks.schedule': {
            'queue': 'analytics'
        },
        'core.investigation.import_task': {
            'queue': 'oneshot'
        },
    }
