...
yeti_config.set_default_value("auth", "access_token_expire_minutes", int(os.getenv("YETI_AUTH_ACCESS_TOKEN_EXPIRE_MINUTES", "30")))
yeti_config.set_default_value("auth", "enabled", os.getenv("YETI_AUTH_ENABLED", "False") == "True")
