...
var cssicons = {
  'Observable.Ip': 'flaticon-lan',
  'Observable.AutonomousSystem': 'flaticon-world-grid',
  'Observable.MacAddress': 'flaticon-lan',
  'Observable.Certificate': 'flaticon-file-1',
  'Observable.CertificateSubject': 'flaticon-file-1',
  'Observable.Hostname': 'flaticon-internet',
  'Observable.Url': 'flaticon-laptop',
  'Observable.Email': 'flaticon-mail',
  'Observable.Bitcoin': 'flaticon-bitcoin',
  'Observable.Text': 'flaticon-text-height-adjustment',
  'Observable.File': 'flaticon-file',
  'Observable.Hash': 'flaticon-fingerprint',
  'Observable.Path': 'flaticon-document',
  'Entity.Malware': 'flaticon-bug',
  'Entity.TTP': 'flaticon-ttp-file',
  'Entity.Company': 'flaticon-enterprise',
  'Entity.Campaign': 'flaticon-advertising',
  'Entity.Actor': 'flaticon-malware',
  'Indicator.Regex': 'flaticon-fingerprint-search-symbol-of-secret-service-investigation',
};
